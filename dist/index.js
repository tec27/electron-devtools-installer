...
var install = function install(extensionReference) {
  ...
  var electronSession = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _electron.session.defaultSession;
  ...
  if (electronSession.getExtension) {
    extensionInstalled = extensionInstalled && electronSession.getAllExtensions().find(function (e) {
  ...
  return (0, _downloadChromeExtension["default"])(chromeStoreID, forceDownload).then(function (extensionFolder) {
    ...
    if (extensionInstalled) {
      ...
      if (electronSession.removeExtension) {
        var extensionId = electronSession.getAllExtensions().find(function (e) {
          return e.name;
        }).id;
    ...
    if (electronSession.loadExtension) {
      return electronSession.loadExtension(extensionFolder).then(function (ext) {
